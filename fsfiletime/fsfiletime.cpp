...
//
//----------------------------------------------------------------------------
BOOLEAN CALLBACK EnumFileCallback(HANDLE hDirectory,PCWSTR DirectoryName,ULONG Flags,
...
VOID EnumDirectoryFiles(CCommandRunParam *pcm, UNICODE_STRING *Path, UNICODE_STRING *FileName)
{
    ...
    NTSTATUS Status;
    Status = EnumFiles(NULL,pszPath,pszName,0,&EnumFileCallback,(ULONG_PTR)pcm);
